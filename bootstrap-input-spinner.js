...
(function ($) {
    ...
    $.fn.InputSpinner = $.fn.inputSpinner = function (options) {
        ...
        var config = {
            ...
            groupClass: "input-group-lg", // css class of the input-group (sizing with input-group-sm, input-group-lg)
        ...
        var html = '<div class="input-group ' + config.groupClass + '">' +
            ...
            '<button style="min-width: ' + config.buttonsWidth + '" class="btn btn-warning btn-decrement ' + config.buttonsClass + '" type="button">' + config.decrementButton + '</button>' +
            '</div>' +
            '<input type="text" style="text-align: ' + config.textAlign + '" class="form-control"/>' +
            '<div class="input-group-append">' +
            '<button style="min-width: ' + config.buttonsWidth + '" class="btn btn-warning btn-increment ' + config.buttonsClass + '" type="button">' + config.incrementButton + '</button>' +
            '</div>' +
            '</div>'
